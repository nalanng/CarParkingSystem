...
namespace CarParkingSystem.Infrastructure.Contexts
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<ParkRecord>()
               .HasOne(pr => pr.Lot)
               .WithMany(pa => pa.ParkRecords)
               .HasForeignKey(pr => pr.LotId);

            builder.Entity<ParkRecord>()
               .HasOne(pr => pr.Status)
               .WithMany(rs => rs.ParkRecords)
